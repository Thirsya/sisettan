                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <a class="btn btn-info btn-primary active import">
                                    ...
                                    Import Jabatan</a>
                                <a class="btn btn-info btn-primary active" href="{{ route('jabatan.export') }}" data-id="export">
                        ...
                        <div class="card-body">
                            <div class="show-import mb-4" style="display: none">
                                ...
                                <div class="custom-file">
                                    <form action="{{ route('jabatan.import') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        <label
                                            class="custom-file-label @error('import-file', 'ImportJabatanRequest') is-invalid @enderror"
