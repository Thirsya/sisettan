                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a class="btn btn-icon icon-left btn-primary" href="{{ route('opd.create') }}">Create New
                                    OPD</a>
                                <a class="btn btn-info btn-primary active import">
                                    <i class="fa fa-download" aria-hidden="true"></i>
                                    Import OPD</a>
                                <a class="btn btn-info btn-primary active" href="{{ route('opd.export') }}" data-id="export">
